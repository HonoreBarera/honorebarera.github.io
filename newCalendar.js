...
// the days change but the pattern remains, donc je doit just qualquer ca au dessus 
// as per the above comment, a function is a meal remember (or a black box) and I can make a million recipes with the same Fx
// onclick, I just need to call funsctions where function showCalendarA,B,C is called 
// function CREATION and function CALL work with function CALL
